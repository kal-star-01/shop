...
export default function WishlistTable() {
  const { wishlist, removeWishlistItem, addToCart } = useStore();
  return (
    <section className="ptb-100" id="wishlist_area">
            ...
            <div className="table_desc border-bottom-0">
              <div className="table_page table-responsive">
                <table>
                  ...
                  <tbody>
                    {wishlist.length ? wishlist.map((e, c) => (
                      <tr key={c}>
                        <td className="product_remove"><button className="bg-transparent remove-btn" onClick={() => removeWishlistItem(e)}><i className="far fa-trash-alt"></i></button></td>
                        ...
                        <td className="product_stock">{e.stock ? 'In Stock' : 'Out of Stock'}</td>
