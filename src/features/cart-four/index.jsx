...
function Page() {
  ...
  return (
    <>
      ...
      <section className="ptb-100" id="cart_area_four">
          ...
          <div className="row">
                    ...
                    <tbody>
                      {ITEMS.map((it, i) => (
                        <tr key={i}>
                          ...
                          <td className="product_name"><a href="product-single.html">{it.title}</a></td>
            ...
            <div className="col-lg-8 col-md-12">
              <div className="coupon_code right" data-aos="fade-up" data-aos-delay="400">
                <h3>Cart Total</h3>
                <div className="coupon_inner">
                  <div className="cart_subtotal"><p>Subtotal</p><p className="cart_amount">$215.00</p></div>
                  <div className="cart_subtotal"><p>Shipping</p><p className="cart_amount"><span>Flat Rate:</span> $255.00</p></div>
                  <a href="#!">Calculate shipping</a>
                  <div className="cart_subtotal"><p>Total</p><p className="cart_amount">$215.00</p></div>
                  <div className="checkout_btn">
                    <a className="theme-btn-one btn-black-overlay btn_sm" href="checkout.html">Proceed to Checkout</a>
                  </div>
                </div>
              </div>
            </div>
