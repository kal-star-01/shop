...
export default function BlogSingle2() {
  usePageMeta({"title":"AndShop - AndShop Ecommerce Vue js Template","metas":[{"name":"description","content":"Blog Single page - AndShop Ecommerce Vue js, Nuxt js Template"}]});
                        ...
                        <div className="common_banner_text">
                          ...
                          <ol className="breadcrumb bg-transparent">
                            ...
                            <li className="breadcrumb-item active">
                              <span aria-current="location">Blog Single</span>
                            </li>
                          </ol>
                        </div>
                      </div>
                      ...
                      <div className="col-lg-9">
                        <div className="blog_single_content">
                          <div className="blog_single_img img-zoom-hover">
                            <img src="/assets/img/blog_single2.1f42de2.png" alt="img" />
                          </div>
                          {' '}
                          ...
                          <div className="card post_author">
                            <div className="card-body">
                              <div className="author_img">
                                <img src="/assets/img/author.45e811a.png" alt="author" />
                              </div>
                              {' '}
                          ...
                          <div className="single_comment_area">
                            ...
                            <ul className="list_none comment_list">
                              <li className="comment_info">
                                <div className="d-flex">
                                  <div className="comment_user">
                                    <img src="/assets/img/user3.3cafa53.png" alt="user3" />
                                  </div>
                                  {' '}
                                ...
                                <ul className="children">
                                  <li className="comment_info">
                                    <div className="d-flex">
                                      <div className="comment_user">
                                        <img src="/assets/img/user1.be89a16.png" alt="user1" />
                                      </div>
                                      {' '}
                                      <div className="comment_content">
                              ...
                              <li className="comment_info">
                                <div className="d-flex">
                                  <div className="comment_user">
                                    <img src="/assets/img/user2.9f6bd36.png" alt="user2" />
                                  </div>
                                  {' '}
                                  <div className="comment_content">
                                    <div className="d-flex">
                            ...
                            <form className="field_form">
                              <div className="row">
                                <div className="form-group col-md-4">
                                  <input name="name" placeholder="Your Name" required={true} type="text" className="form-control" />
                                </div>
                                {' '}
                                <div className="form-group col-md-4">
                                  <input name="email" placeholder="Your Email" required={true} type="email" className="form-control" />
                                </div>
                                {' '}
                                <div className="form-group col-md-4">
                                  <input name="website" placeholder="Your Website" required={true} type="text" className="form-control" />
                                </div>
                                {' '}
                                <div className="form-group col-md-12">
                                  <textarea rows="3" name="message" placeholder="Your Comment" required={true} className="form-control"></textarea>
                                </div>
                                {' '}
                                <div className="form-group col-md-12">
                                  <button name="submit" title="Submit Your Message!" className="theme-btn-one btn_md btn-black-overlay">
                                                                              Submit
                                                                          </button>
                                </div>
                              </div>
                          ...
                          <div className="left-sidebar shop-sidebar-wrap">
                              ...
                              <div className="search-widget">
                                <form>
                                  <div className="input-group">
                                    <input placeholder="Search entire store here ..." type="text" className="form-control" />
                                    {' '}
                                    <button>
                              ...
                              <div className="recent-post-widget">
                                <div className="recent-single-post d-flex">
                                  ...
                                  <div className="media-side">
                                    <h5>
                                      <a href="/blog/This%20Designer%20Bronzer%20Has%20Even%20The%20Drugstore-Beauty-Buyers%20Splurging!" className="">This Designer Bronzer Has...</a>
                                    </h5>
                                    {' '}
                                ...
                                <div className="recent-single-post d-flex">
                                  ...
                                  <div className="media-side">
                                    <h5>
                                      <a href="/blog/4%20Fresh%20Ways%20To%20Style%20Leather%20Shorts%20For%20Spring" className="">4 Fresh Ways To Style Lea...</a>
                                    </h5>
                                    {' '}
                                    <span className="date">29 jan 2018</span>
                                  </div>
                                </div>
                                <div className="recent-single-post d-flex">
                                  <div className="thumb-side img-zoom-hover">
                                  ...
                                  <div className="media-side">
                                    <h5>
                                      <a href="/blog/Shopbop%20Spring%20Sale%20Selects%20All%20Under%20Around%20$100!" className="">Shopbop Spring Sale Selec...</a>
                                    </h5>
                                    {' '}
                                    <span className="date">24 February 2021</span>
                                  </div>
                            ...
                            <div className="sidebar-widget mt-40px">
                              ...
                              <div className="flicker-widget">
                                <ul>
                                  <li className="img-zoom-hover"><a className="image-link" href="https://www.instagram.com/" target="_blank" rel="noreferrer"><img src="/assets/img/post2.674c295.png" alt="instagram" /></a></li>
                                  <li className="img-zoom-hover"><a className="image-link" href="https://www.instagram.com/" target="_blank" rel="noreferrer"><img src="/assets/img/post3.9bf54f3.png" alt="instagram" /></a></li>
                                  <li className="img-zoom-hover"><a className="image-link" href="https://www.instagram.com/" target="_blank" rel="noreferrer"><img src="/assets/img/post4.362f450.png" alt="instagram" /></a></li>
                                  <li className="img-zoom-hover"><a className="image-link" href="https://www.instagram.com/" target="_blank" rel="noreferrer"><img src="/assets/img/post5.2d86a40.png" alt="instagram" /></a></li>
                                  <li className="img-zoom-hover"><a className="image-link" href="https://www.instagram.com/" target="_blank" rel="noreferrer"><img src="/assets/img/post6.cde1726.png" alt="instagram" /></a></li>
                                  <li className="img-zoom-hover"><a className="image-link" href="https://www.instagram.com/" target="_blank" rel="noreferrer"><img src="/assets/img/post7.d641f7f.png" alt="instagram" /></a></li>
                                  <li className="img-zoom-hover"><a className="image-link" href="https://www.instagram.com/" target="_blank" rel="noreferrer"><img src="/assets/img/post8.7c75846.png" alt="instagram" /></a></li>
                                  <li className="img-zoom-hover"><a className="image-link" href="https://www.instagram.com/" target="_blank" rel="noreferrer"><img src="/assets/img/post9.1d6a1b5.png" alt="instagram" /></a></li>
                                  <li className="img-zoom-hover"><a className="image-link" href="https://www.instagram.com/" target="_blank" rel="noreferrer"><img src="/assets/img/post10.09f338d.png" alt="instagram" /></a></li>
                                  <li className="img-zoom-hover"><a className="image-link" href="https://www.instagram.com/" target="_blank" rel="noreferrer"><img src="/assets/img/post11.8f7e2e2.png" alt="instagram" /></a></li>
                                  <li className="img-zoom-hover"><a className="image-link" href="https://www.instagram.com/" target="_blank" rel="noreferrer"><img src="/assets/img/post12.76401dd.png" alt="instagram" /></a></li>
                                  <li className="img-zoom-hover"><a className="image-link" href="https://www.instagram.com/" target="_blank" rel="noreferrer"><img src="/assets/img/post1.3665af9.png" alt="instagram" /></a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
